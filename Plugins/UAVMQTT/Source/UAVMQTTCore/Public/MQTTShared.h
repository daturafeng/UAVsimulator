...
struct UAVMQTTCORE_API FMQTTURL
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UAVMQTTCORE_API FMQTTTopic
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UAVMQTTCORE_API FMQTTTopicFilter : public FMQTTTopic
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct UAVMQTTCORE_API FMQTTTopicTemplate : public FMQTTTopic
{
	GENERATED_BODY()
...
struct UAVMQTTCORE_API FMQTTSubscription
{
	/** Construct from path. */
...
struct UAVMQTTCORE_API FMQTTSubscribeResult
{
